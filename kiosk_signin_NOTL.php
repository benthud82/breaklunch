                ...
                <div id="container_breaklunch" class="hidden">
                    <div class="row" style="padding-top: 75px;  margin: 0px; width: 100%; text-align: center;">
                        ...
                        <div class="col-xs-10 col-xs-offset-1 ">
                            ...
                            <button style="display: inline-block; width: 275px; height: 100px; margin: 20px; font-weight: 900;font-size: 29px;" class="btn btn-lg btn-danger btn-block click_breaklunch" type="submit" id="click_lunch" data-whse="<?php echo $whse ?>" data-type="ENDOFDAY"  >End of Day</button>
                        </div>
